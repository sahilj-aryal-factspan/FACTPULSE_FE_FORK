...
import type { GovernanceRecord, Risk, Action } from '../../store/data-store';
    ...
    <>
      ...
      >
        ...
        <div style={{ marginBottom: '20px', fontSize: '13px', color: '#94a3b8', display: 'flex', alignItems: 'center', gap: '6px' }}>
          <Link to="/portfolio" style={{ textDecoration: 'none', color: '#94a3b8' }}>Portfolio</Link>
          <span>›</span>
          <Link to="/accounts" style={{ textDecoration: 'none', color: '#94a3b8' }}>Accounts</Link>
          {account && (
            <>
              <span>›</span>
              <Link to={`/accounts/${account.id}`} style={{ textDecoration: 'none', color: '#94a3b8' }}>
                {account.name}
              </Link>
            </>
          )}
          <span>›</span>
          <span style={{ color: '#1e3a8a', fontWeight: 700 }}>{project.name}</span>
        </div>
